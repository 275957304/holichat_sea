define(function(require, exports, module) {
    var template  = '<div class="prompt-app">';
        ...
        template += '<div style="width: 35px;text-align:center" id="appBannerColse" class="prompt-close"><i class="weui_icon_cancel"></i></div>';
    ...
    function addApp(){
        ...
        //提示用户安装app区 的关闭按钮
        $(document).on('click','#appBannerColse',function(){
            alert('广告');
