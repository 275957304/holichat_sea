				...
				switch (item.type) {
					...
					case 'checkbox':
						...
						$(item.options).each(function(i,val){
							...
							checkbox += '<label class="weui_cell weui_check_label" for="'+ (item.name + suffix + i) +'"><div class="weui_cell_bd weui_cell_primary"><p>'+ val.label +'</p></div><div class="weui_cell_hd checkbox_icon"><input type="checkbox" '+ isChecked +' class="weui_check" data-required="'+ item.required +'" data-type="checkbox" data-label="'+ item.label +'" name="'+ item.name +'" id="'+ (item.name + suffix + i) +'" value="'+ val.label +'"><i class="weui_icon_checked"></i></div></label>'
						})
						...
						break;
					case 'image_file':
						template += '<div class="weui_cells"><div class="weui_cell"><div style="padding-left:0;color:#333;" class="weui_cells_tips">'+ item.label +'</div><div class="weui_cell_bd weui_cell_primary"><div class="weui_uploader_input_wrp"><input class="weui_uploader_input" data-required="'+ item.required +'" data-url="" data-type="image_file" id="'+ (item.name + suffix) +'" name="'+ item.name +'" type="file" ><div class="weui_uploader_file"></div></div></div></div></div>'
						break;
					case 'label':
					...
					case 'certificate': //证件
						...
						template += '<div class="weui_cells"><div class="weui_cell weui_cell_select weui_select_before"><div class="weui_cell_hd"><select data-type="certificate" class="weui_select" data-required="'+ item.required +'"  data-label="'+ item.label +'" id="'+ (item.name + suffix) +'" name="'+ item.name +'">'+ options +'</select></div><div class="weui_cell_bd weui_cell_primary"><input class="weui_input" data-type="certificate"  data-required="'+ item.required +'" name="'+ item.name +'" type="text" placeholder="请输入证件号码"></div></div></div>'
						break;
					case 'number':
